...
Item {
  ...
  readonly property var shortcuts: [
    ...
    { key: "Ctrl+Alt+arrows / Ctrl+Alt+H J K L", action: "Resize the selected tile, text, or divider" },
    { key: "Edit toolbar", action: "Draw a divider or add scalable text" },
    { key: "Placement: arrows or H J K L / Ctrl", action: "Move / resize; Enter places, Esc cancels" },
