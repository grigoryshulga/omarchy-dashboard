...
вертикальной и горизонтальной центральным осям. Двойной клик по
...
В центре шапки находится компактная карусель Spaces: активный Space показан
своим названием в акцентном цвете, остальные — круглыми индикаторами. В `edit`
индикатор можно перетащить, чтобы изменить порядок Spaces; отдельная кнопка
